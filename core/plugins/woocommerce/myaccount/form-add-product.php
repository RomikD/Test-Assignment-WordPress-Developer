...
<div id="add-product">
    ...
    <!--    <div class="form-select form-group field-productFtr">-->
    <!--        <label for="productFtr" class="form-select-label">Product featured ?<span class="form-required">*</span></label>-->
    <!--        <select class="form-productFtr" name="productFtr" id="productFtr" required="required" aria-required="true">-->
    <!--            <option value="option-1" selected="true" id="productFtr-0">Yes</option>-->
    <!--            <option value="option-2" id="productFtr-1">No</option>-->
    <!--        </select>-->
    <!--    </div>-->
